...
export default async function Page() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-10">
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Accessories</h1>
        <p className="text-gray-500 text-sm mt-2">Complete your look with our accessories.</p>
      </div>
